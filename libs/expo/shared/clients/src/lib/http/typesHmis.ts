 ...
 */
export type HttpQueryParamsHmis = Record<
  string,
  string | number | boolean | null | undefined
>;

export interface ListParamsHmis {
  page?: number;
  per_page?: number;
}

export interface RequestOptionsHmis extends Omit<RequestInit, 'body'> {
...
export interface CurrentUserHmis {
  id: number;
  first_name: string;
  last_name: string;
  isAdmin: number;
...
export interface ValidationErrorHmis {
  field: string;
  message: string;
}

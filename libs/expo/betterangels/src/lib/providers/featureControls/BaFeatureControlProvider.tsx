...
import {
  GetBaFeatureControlsDocument,
  GetBaFeatureControlsQuery,
} from './__generated__/featureControls.generated';

export function BaFeatureControlProvider({
  children,
}: {
  ...
  const { data, refetch, loading, error } = useQuery<GetBaFeatureControlsQuery>(
    GetBaFeatureControlsDocument,
    {

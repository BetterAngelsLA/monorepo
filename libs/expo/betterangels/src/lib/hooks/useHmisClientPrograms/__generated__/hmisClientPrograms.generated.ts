...
export type HmisClientProgramsQuery = { __typename?: 'Query', hmisClientPrograms: Array<{ __typename: 'HmisClientProgramType', id: string, program: { __typename?: 'HmisProgramType', id: string, name: string, enableNotes?: number | null } }> };

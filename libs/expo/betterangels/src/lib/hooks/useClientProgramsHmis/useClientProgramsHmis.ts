...
import { ClientProgramsHmisDocument } from './__generated__/clientProgramsHmis.generated';
...
export function useClientProgramsHmis(props: TProps) {
  ...
  const {
    ...
    loading,
    error: queryError,
  } = useQuery(ClientProgramsHmisDocument, {
    skip: !clientId,
    variables: { clientId },

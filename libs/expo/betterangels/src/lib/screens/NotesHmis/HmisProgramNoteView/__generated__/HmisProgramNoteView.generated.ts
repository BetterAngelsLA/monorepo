...
export type ViewHmisNoteQueryVariables = Types.Exact<{
  id: Types.Scalars['ID']['input'];
}>;

export type ViewHmisNoteQuery = {
  __typename?: 'Query';
  hmisNote: {
    ...
    clientProgram?: {
      ...
      id: string;
      program: { __typename?: 'HmisProgramType'; id: string; name: string };
    } | null;
    tasks?: Array<{
      __typename?: 'TaskType';
      id: string;
...
export const ViewHmisNoteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ViewHmisNote' },
      variableDefinitions: [
        {
              ...
              selections: [
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'HmisNoteType' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'hmisClientProfile' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'clientProgram' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'providedServices' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
...
} as unknown as DocumentNode<ViewHmisNoteQuery, ViewHmisNoteQueryVariables>;

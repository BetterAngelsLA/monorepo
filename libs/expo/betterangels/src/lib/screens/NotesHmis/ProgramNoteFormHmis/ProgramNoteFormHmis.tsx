...
import { useClientProgramsHmis } from '../../../hooks';
import { useModalScreen } from '../../../providers';
import { GirpNoteForm } from '../../../ui-components';
import LocationComponentHmis from '../LocationHmis';
import ProvidedServicesHmis from './ProvidedServicesHmis';
...
export function ProgramNoteFormHmis(props: TProps) {
  ...
  } = useClientProgramsHmis({ clientId });
  ...
  return (
    <Form style={{ gap: Spacings.xs }}>
      ...
      <ProvidedServicesHmis
        services={
          services[ServiceRequestTypeEnum.Provided]?.serviceRequests || []
        }
      />
      <RequestedServicesHmis
        services={
          services[ServiceRequestTypeEnum.Requested]?.serviceRequests || []
        }
      />

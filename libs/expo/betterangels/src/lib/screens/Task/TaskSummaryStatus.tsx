...
import { useUpdateTaskSummaryStatusMutation } from './__generated__/UpdateTaskSummaryStatus.generated';
...
type TaskSummaryStatusProps = {
  id: TaskType['id'];
  status: TaskType['status'];
};

export default function TaskSummaryStatus(props: TaskSummaryStatusProps) {
  const { id, status } = props;
  const [updateTaskMutation] = useUpdateTaskSummaryStatusMutation();

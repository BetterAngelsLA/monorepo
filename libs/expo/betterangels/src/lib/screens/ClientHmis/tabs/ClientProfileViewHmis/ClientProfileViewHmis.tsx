...
import { getEditButtonRouteHmis } from '../../../Client/ClientProfile/utils/getEditButtonRouteHmis';
import {
...
export function ClientProfileViewHmis(props: TProps) {
  ...
  function onClickEdit(card: ClientProfileSectionEnum) {
    ...
    const route = getEditButtonRouteHmis({
      profileId: id,
      section: card,
    });

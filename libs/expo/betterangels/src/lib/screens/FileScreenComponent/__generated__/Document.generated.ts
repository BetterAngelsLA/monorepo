...
export type ClientDocumentQuery = { __typename?: 'Query', clientDocument: { __typename?: 'ClientDocumentType', id: string, createdAt: import('@monorepo/ba-platform').DateTimeString, namespace: Types.ClientDocumentNamespaceEnum, originalFilename?: string | null, attachmentType: Types.AttachmentType, mimeType: string, file: { __typename?: 'DjangoFileType', url: string, name: string } } };

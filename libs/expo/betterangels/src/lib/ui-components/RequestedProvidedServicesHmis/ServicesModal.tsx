...
import {
  ServiceCategoriesHmisDocument,
  ServiceCategoriesHmisQuery,
} from './__generated__/ServicesHmis.generated';
...
type ApiCategory =
  ServiceCategoriesHmisQuery['serviceCategories']['results'][number];

...
export type TeamsQuery = { __typename?: 'Query', teams: { __typename?: 'TeamTypeOffsetPaginated', results: Array<{ __typename?: 'TeamType', id: string, slug: string, name: string, isActive: boolean }>, totalCount: number } };

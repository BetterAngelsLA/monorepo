...
export type GenerateClientProfilePhotoUploadMutation = { __typename?: 'Mutation', generateClientProfilePhotoUpload:
    ...
    | { __typename?: 'PresignedS3UploadResultItem', refId: string, url: string, fields: any, key: string, signatureKey?: string | null }
   };

...
export type UpdateTaskMutation = { __typename?: 'Mutation', updateTask:
    ...
    | { __typename?: 'TaskType', id: string, summary?: string | null, description?: string | null, status?: Types.TaskStatusEnum | null, updatedAt: any, currentTeam?: { __typename?: 'TeamType', id: string, slug?: string | null, name: string } | null }
   };

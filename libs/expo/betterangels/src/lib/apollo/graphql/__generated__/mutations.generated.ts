...
export type DeleteCurrentUserMutationVariables = Types.Exact<{
  [key: string]: never;
}>;
...
>;
export const UpdateNoteLocationDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateNoteLocation' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'data' } },
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UpdateNoteLocationInput' },
            },
          },
        },
      ],

...
export const enumNameQualityHmis: {
...
export const enumDobQualityHmis: {
...
export const enumVeteranStatusHmis: {
...
export const enumDisplaySuffixHmis: {
...
export function getExistingSuffixHmis(value?: HmisSuffixEnum): string {
  if (!value || excludedSuffixes.includes(value)) {
    return '';
  }

  return enumDisplaySuffixHmis[value] || '';
}

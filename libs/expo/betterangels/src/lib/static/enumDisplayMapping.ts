...
export const enumDisplayServices: { [key in ServiceEnum]: string } = {
  ...
  [ServiceEnum.HarmReductionSafeSmoking]: 'Harm Reduction - Safe Smoking',
  [ServiceEnum.HarmReductionNarcan]: 'Harm Reduction - Narcan',
  [ServiceEnum.HarmReductionTestKit]: 'Harm Reduction - Test Kit',

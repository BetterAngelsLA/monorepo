...
export type ViewSheltersByOrganizationQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const ViewSheltersByOrganizationDocument = gql`
  ...
  sheltersByOrganization(organizationId: 1) {
    results {
      id
      name
    }
 ...
 * });
 */
export function useViewSheltersByOrganizationQuery(baseOptions?: Apollo.QueryHookOptions<ViewSheltersByOrganizationQuery, ViewSheltersByOrganizationQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}

...
export type AdminTeamsQuery = { __typename?: 'Query', teams: { __typename?: 'TeamTypeOffsetPaginated', totalCount: number, results: Array<{ __typename?: 'TeamType', id: string, name: string, isActive?: boolean | null, isInUse: boolean, createdAt: DateTimeString }> } };

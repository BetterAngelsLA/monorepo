...
export type AdminTeamsQuery = { __typename?: 'Query', teams: { __typename?: 'OffsetPaginated_TeamType', results: Array<{ __typename?: 'TeamType', id: string, slug: string, name: string, isActive: boolean, createdAt?: string | null }>, totalCount: number } };
...
export type CreateTeamMutation = { __typename?: 'Mutation', createTeam:
    ...
    | { __typename?: 'TeamType', id: string, slug: string, name: string, isActive: boolean, createdAt?: string | null }
   };

...
export type AdminTeamsQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type AdminTeamsQuery = { __typename?: 'Query', teams: Array<{ __typename?: 'TeamType', id: string, slug: string, name: string, isActive: boolean }> };
...
export type CreateTeamMutation = { __typename?: 'Mutation', createTeam:
    ...
    | { __typename?: 'TeamType', id: string, slug: string, name: string, isActive: boolean }
   };

...
export type AdminTeamsQuery = { __typename?: 'Query', teams: { __typename?: 'TeamTypeOffsetPaginated', totalCount: number, results: Array<{ __typename?: 'TeamType', id: string, slug: string, name: string, isActive: boolean, createdAt: any }> } };
...
export type CreateTeamMutation = { __typename?: 'Mutation', createTeam:
    ...
    | { __typename?: 'TeamType', id: string, slug: string, name: string, isActive: boolean, createdAt: any }
   };

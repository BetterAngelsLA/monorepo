...
export type AdminTeamsQuery = { __typename?: 'Query', teams: { __typename?: 'TeamTypeOffsetPaginated', totalCount: number, results: Array<{ __typename?: 'TeamType', id: string, name: string, createdAt: any }> } };
...
export type CreateTeamMutation = { __typename?: 'Mutation', createTeam:
    ...
    | { __typename?: 'TeamType', id: string, name: string, createdAt: any }
   };

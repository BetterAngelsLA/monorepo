...
export type CurrentOrgUserQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', id: string, username?: string | null, firstName?: string | null, lastName?: string | null, email?: string | null, organizations?: Array<{ __typename?: 'OrganizationForUserType', id: string, name: string, userPermissions?: Array<Types.UserOrganizationPermissions> | null }> | null } };

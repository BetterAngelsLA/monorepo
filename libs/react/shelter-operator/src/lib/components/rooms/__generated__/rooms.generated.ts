...
export type GetShelterRoomsQuery = { __typename?: 'Query', rooms: { __typename?: 'RoomTypeOffsetPaginated', results: Array<{ __typename?: 'RoomType', id: string, name: string, status?: Types.RoomStatusChoices | null, amenities?: string | null, medicalRespite: boolean }> } };

...
export type AddOrganizationMemberMutation = { __typename: 'Mutation', addOrganizationMember:
    ...
    | { __typename: 'OrganizationMemberType', id: string, email?: string | null, firstName?: string | null, lastName?: string | null, memberRole: Types.OrgRoleEnum, middleName?: string | null, dateJoined: import('../../../../types').DateTimeString }
   };

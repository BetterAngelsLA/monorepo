...
export type ShelterOperatorOrganizationsQuery = { __typename: 'Query', shelterOrganizations: { __typename: 'OrganizationTypeOffsetPaginated', results: Array<{ __typename: 'OrganizationType', id: string, name: string }> } };

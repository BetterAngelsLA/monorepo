...
export type Scalars = {
  ...
  /** Date (isoformat) */
  Date: { input: import('@monorepo/ba-platform').DateString; output: import('@monorepo/ba-platform').DateString; }
  /** Date with time (isoformat) */
  DateTime: { input: import('@monorepo/ba-platform').DateTimeString; output: import('@monorepo/ba-platform').DateTimeString; }
  ...
  PhoneNumber: { input: import('@monorepo/ba-platform').PhoneNumberString; output: import('@monorepo/ba-platform').PhoneNumberString; }
  /** Represents a point as `(x, y, z)` or `(x, y)`. */
  Point: { input: any; output: any; }
  /** Time (isoformat) */
  Time: { input: import('@monorepo/ba-platform').TimeString; output: import('@monorepo/ba-platform').TimeString; }
  UUID: { input: import('@monorepo/ba-platform').UUIDString; output: import('@monorepo/ba-platform').UUIDString; }
...
export type BedType = {
  ...
  id: Scalars['ID']['output'];
  lastCleaned?: Maybe<Scalars['DateTime']['output']>;
...
export type CreateReservationInput = {
  ...
  status?: InputMaybe<ReservationStatusChoices>;
};

export type CreateReservationPayload = OperationInfo | ReservationType;
...
export type DeleteReservationsPayload = BulkDeleteResult | OperationInfo;
...
export type MutationChangeOrganizationMemberRoleArgs = {
  data: ChangeOrganizationMemberRoleInput;
};
...
export type Query = {
  ...
  reservations: ReservationTypeOffsetPaginated;
  room: RoomType;
...
export type QueryReservationsArgs = {
  ...
  ordering?: Array<ReservationOrder>;
  pagination?: InputMaybe<OffsetPaginationInput>;
};
...
export type ReservationClientInput = {
  clientProfileId: Scalars['ID']['input'];
...
export type ReservationOrder = {
  checkedInAt?: InputMaybe<Ordering>;
  checkedOutAt?: InputMaybe<Ordering>;
  createdAt?: InputMaybe<Ordering>;
...
export type ReservationType = {
  ...
  clients: Array<ReservationClientAssignmentType>;
...
export type ShelterPropertyInput = {
  ...
  pets?: InputMaybe<Array<PetChoices>>;
  petsIncludeNull?: InputMaybe<Scalars['Boolean']['input']>;
  referralRequirement?: InputMaybe<Array<ReferralRequirementChoices>>;
...
export type UpdateBedPayload = BedType | OperationInfo;
...
export type UpdateRoomPayload = OperationInfo | RoomType;

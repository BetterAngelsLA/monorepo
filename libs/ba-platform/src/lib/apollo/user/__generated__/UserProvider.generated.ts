...
export type CurrentOrgUserQuery = { __typename: 'Query', currentUser: { __typename: 'CurrentUserType', id: string, username?: string | null, firstName?: string | null, lastName?: string | null, email?: string | null, permissions: Array<string>, organizations?: Array<{ __typename: 'CurrentUserOrganizationType', id: string, name: string, permissions: Array<string> }> | null } };

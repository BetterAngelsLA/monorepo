    ...
    <div className="md:-mx-10 -mx-4">
      ...
      <div className="py-7 md:py-32 px-4 md:px-10 max-w-7xl mx-auto">
        ...
        <p className="md:text-2xl mb-6 md:mb-12">
          ...
          together to support Angelinos affected by the devastating January 2025
          wildfires. Each partner brings unique expertise and a shared
        ...
        <ul className="md:text-2xl ml-6 mb-6 md:mb-32">
          ...
          <li className="list-disc">
            <span className="font-bold">Mayor Karen Bass's Office</span>: Leads
            the nation's second largest city with urgency to delivered results
            for all Angelenos.
          </li>
        </ul>
        <h2 className="text-2xl md:text-5xl mb-6 md:mb-16 border-l-[10px] border-brand-sky-blue pl-4 md:pl-8 font-bold">
        ...
        <p className="mb-6 md:mb-32 md:text-2xl">
          ...
          Angelinos affected by the wildfires. Through this platform, we aim to
        ...
        <p className="mb-6 md:mb-32 md:text-2xl">
          ...
          working together, we aim to ensure no Angelino faces these challenges

...
export const qIsSmallBusiness: TQuestion = {
  ...
  note: '*Note: Qualified non-profit organizations whose facilities have been impacted by the wildfires, can be eligible for FEMA disaster assistance (FEMA.gov)',
  options: [
    {

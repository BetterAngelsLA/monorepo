    ...
    <>
      <Hero backgroundImage={fireHero} className="min-h-[75vh]">
        <div className="w-full bg-[rgba(30,51,66,0.3)] md:bg-[rgba(30,51,66,0.6)] h-full md:h-auto pt-12 pb-[4.5rem] md:py-16 text-white px-10">
          <div className="max-w-[62.5rem] mx-auto flex flex-col md:flex-row items-center">
            <h1 className="flex-1 mb-10 md:mb-0 border-l-[10px] border-brand-yellow pl-4 text-left text-5xl md:text-[64px] md:leading-[1.2] font-extralight">
              We are here to help
            </h1>

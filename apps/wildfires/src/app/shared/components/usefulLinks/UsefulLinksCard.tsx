...
export default function UsefulLinksCard(props: IUsefulLinksCardProps) {
  ...
  return (
    <div className="md:bg-white flex-1 p-6 flex flex-col items-center justify-between aspect-video">
      <div className="flex items-center justify-center flex-1">{children}</div>
      <a
        href={url}
        className="flex items-center justify-center mt-8 gap-2 bg-white md:bg-transparent py-5 w-full rounded-[50px]"
      >

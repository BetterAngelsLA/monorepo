...
class ClientProfileMutationTestCase(ClientProfileGraphQLBaseTestCase):
    ...
    def test_client_profile_mutation_validation(self) -> None:
        ...
        self.assertEqual(len(error_messages), 4)
        ...
        self.assertEqual(error_messages[1]["field"], "contacts")
        self.assertEqual(error_messages[1]["location"], "0__phoneNumber")
        self.assertEqual(error_messages[1]["errorCode"], ErrorMessageEnum.INVALID_PHONE_NUMBER.name)
        self.assertEqual(error_messages[2]["field"], "hmisProfiles")
        self.assertEqual(error_messages[2]["location"], "0__hmisId")
        self.assertEqual(error_messages[2]["errorCode"], ErrorMessageEnum.HMIS_ID_IN_USE.name)
        self.assertEqual(error_messages[3]["field"], "phoneNumbers")
        self.assertEqual(error_messages[3]["location"], "0__number")

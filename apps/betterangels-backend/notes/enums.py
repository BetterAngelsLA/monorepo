...
class ServiceEnum(models.TextChoices):
    ...
    HARM_REDUCTION_NARCAN = "harm_reduction_narcan", _("Harm Reduction - Narcan")
    HARM_REDUCTION_SAFE_SMOKING = "harm_reduction_safe_smoking", _("Harm Reduction - Safe Smoking")
    HARM_REDUCTION_TEST_KIT = "harm_reduction_test_kit", _("Harm Reduction - Test Kit")

...
class ClientProfilePermissions(models.TextChoices):
    VIEW = "accounts.view_clientprofile", "Can view clientprofile"
    CHANGE = "accounts.change_clientprofile", "Can change clientprofile"
    DELETE = "accounts.delete_clientprofile", "Can delete clientprofile"
    ADD = "accounts.add_clientprofile", "Can add clientprofile"

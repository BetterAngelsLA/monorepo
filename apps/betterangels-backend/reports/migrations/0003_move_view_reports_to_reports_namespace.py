"""Move view_reports permission from organizations.Organization CT to reports.ScheduledReport CT.

This migrates the permission in all PermissionGroupTemplates and Groups that reference it,
then deletes the old permission on the Organization content type.
"""

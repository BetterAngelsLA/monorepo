...
@strawberry_django.order(Shelter)
class ShelterOrder:
    name: auto


@strawberry_django.order_type(Shelter)
class NewShelterOrder:
    name: auto
...
@strawberry_django.type(Shelter, filters=ShelterFilter, order=ShelterOrder, ordering=NewShelterOrder)  # type: ignore
class ShelterType:
    id: ID

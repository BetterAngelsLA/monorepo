...
class PopulationChoices(models.TextChoices):
    ...
    ENHANCED_BRIDGE_HOUSING_FOR_OLDER_ADULTS = (
        "enhanced_bridge_housing_older_adults",
        _("Enhanced Bridge Housing for Older Adults"),
    )
    ...
    JUSTICE_SYSTEM_EXITING = (
        "justice_system_exiting",
        _("B7 Bridge Housing for Persons Exiting Justice System Institutions"),
    )
    LGBTQ = "lgbtq", _("LGBTQ")
    MEN = "men", _("Men")

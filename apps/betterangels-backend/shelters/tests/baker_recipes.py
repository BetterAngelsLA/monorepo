...
shelter_recipe = Recipe(
    ...
    demographics_other=lambda: [],  # type: ignore
    ...
    funders_other=lambda: [],  # type: ignore
    ...
    room_styles_other=lambda: [],  # type: ignore
    shelter_programs_other=lambda: [],  # type: ignore
    shelter_types_other=lambda: [],  # type: ignore

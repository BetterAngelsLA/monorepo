...
def modify_shelter_group_permissions(apps, schema_editor):
    from shelters.models import InteriorShelterPhoto, ExteriorShelterPhoto

    permission_map = {
        InteriorShelterPhoto: [InteriorShelterPhoto.perms],
        ExteriorShelterPhoto: [ExteriorShelterPhoto.perms],
    }

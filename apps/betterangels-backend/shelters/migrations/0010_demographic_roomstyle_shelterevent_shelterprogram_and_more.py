    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("bed_fees", models.TextField(blank=True, null=True)),
                ("program_fees", models.TextField(blank=True, null=True)),
                (
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "shelters_shelterevent" ("address_id", "bed_fees", "city_council_district", "created_at", "curfew", "description", "email", "entry_info", "id", "max_stay", "name", "on_site_security", "organization_id", "other_rules", "other_services", "overall_rating", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "phone", "program_fees", "status", "subjective_review", "supervisorial_district", "total_beds", "updated_at", "website") VALUES (NEW."address_id", NEW."bed_fees", NEW."city_council_district", NEW."created_at", NEW."curfew", NEW."description", NEW."email", NEW."entry_info", NEW."id", NEW."max_stay", NEW."name", NEW."on_site_security", NEW."organization_id", NEW."other_rules", NEW."other_services", NEW."overall_rating", _pgh_attach_context(), NOW(), \'insert\', NEW."id", NEW."phone", NEW."program_fees", NEW."status", NEW."subjective_review", NEW."supervisorial_district", NEW."total_beds", NEW."updated_at", NEW."website"); RETURN NULL;',
                    hash="f0e7dcbc3c6eaa17dfe035fe69787f44ef373771",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="825572e27b32f6be7f421d919c712cc214cb812c",
                    operation="UPDATE",

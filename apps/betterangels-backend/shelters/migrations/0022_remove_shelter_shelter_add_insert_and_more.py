# Generated by Django 5.2.9 on 2026-01-12 20:08
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "shelters_shelterevent" ("add_notes_shelter_details", "add_notes_sleeping_details", "bed_fees", "cities_other", "city_council_district", "created_at", "curfew", "demographics_other", "description", "email", "emergency_surge", "entry_info", "exit_policy_other", "funders_other", "geolocation", "hero_image_content_type_id", "hero_image_object_id", "id", "instagram", "intake_hours", "location", "max_stay", "name", "on_site_security", "operating_hours", "organization_id", "other_rules", "other_services", "overall_rating", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "phone", "program_fees", "room_styles_other", "shelter_programs_other", "shelter_types_other", "status", "subjective_review", "supervisorial_district", "total_beds", "updated_at", "visitors_allowed", "website") VALUES (NEW."add_notes_shelter_details", NEW."add_notes_sleeping_details", NEW."bed_fees", NEW."cities_other", NEW."city_council_district", NEW."created_at", NEW."curfew", NEW."demographics_other", NEW."description", NEW."email", NEW."emergency_surge", NEW."entry_info", NEW."exit_policy_other", NEW."funders_other", NEW."geolocation", NEW."hero_image_content_type_id", NEW."hero_image_object_id", NEW."id", NEW."instagram", NEW."intake_hours", NEW."location", NEW."max_stay", NEW."name", NEW."on_site_security", NEW."operating_hours", NEW."organization_id", NEW."other_rules", NEW."other_services", NEW."overall_rating", _pgh_attach_context(), NOW(), \'shelter.add\', NEW."id", NEW."phone", NEW."program_fees", NEW."room_styles_other", NEW."shelter_programs_other", NEW."shelter_types_other", NEW."status", NEW."subjective_review", NEW."supervisorial_district", NEW."total_beds", NEW."updated_at", NEW."visitors_allowed", NEW."website"); RETURN NULL;',
                    hash="84cce5bcb7dc9c8d35e28563409244c1afaaac91",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="cb6fd32e61a7c3fc48fd1bb3a5a08420341d40ba",
                    operation="UPDATE",

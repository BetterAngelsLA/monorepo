# Generated by Django 5.2.8 on 2025-11-13 23:57
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hmis_client_profile",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="notes", to="hmis.hmisclientprofile"
                    ),
                ),
            ],
            options={
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "hmis_hmisnoteevent" ("added_date", "created_at", "created_by_id", "date", "hmis_client_profile_id", "hmis_id", "id", "last_updated", "note", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "ref_client_program", "title", "updated_at") VALUES (NEW."added_date", NEW."created_at", NEW."created_by_id", NEW."date", NEW."hmis_client_profile_id", NEW."hmis_id", NEW."id", NEW."last_updated", NEW."note", _pgh_attach_context(), NOW(), \'hmisnote.add\', NEW."id", NEW."ref_client_program", NEW."title", NEW."updated_at"); RETURN NULL;',
                    hash="7bb830e06e39e21a8625f4c29f25e4d44f71b8c4",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="a75f5d0d45b53b1061cbd70c2b60285c1fda9784",
                    operation="UPDATE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="3dc246ecf449744709a68c6316e61c3136e4df27",
                    operation="DELETE",

# Generated by Django 5.2.7 on 2025-11-04 21:47
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "hmis_hmisclientprofileevent" ("ada_accommodation", "additional_race_ethnicity", "address", "california_id", "created_at", "date_of_birth", "different_identity_text", "dob", "dob_data_quality", "email", "eye_color", "first_name", "gender", "gender_other", "hair_color", "height_in_inches", "id", "important_notes", "last_name", "living_situation", "mailing_address", "marital_status", "middle_name", "name_data_quality", "name_suffix", "nickname", "personal_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "phone_number", "physical_description", "place_of_birth", "preferred_communication", "preferred_language", "profile_photo", "pronouns", "pronouns_other", "race", "race_ethnicity", "residence_address", "residence_geolocation", "spoken_languages", "ssn1", "ssn2", "ssn3", "ssn_data_quality", "unique_identifier", "updated_at", "veteran_status") VALUES (NEW."ada_accommodation", NEW."additional_race_ethnicity", NEW."address", NEW."california_id", NEW."created_at", NEW."date_of_birth", NEW."different_identity_text", NEW."dob", NEW."dob_data_quality", NEW."email", NEW."eye_color", NEW."first_name", NEW."gender", NEW."gender_other", NEW."hair_color", NEW."height_in_inches", NEW."id", NEW."important_notes", NEW."last_name", NEW."living_situation", NEW."mailing_address", NEW."marital_status", NEW."middle_name", NEW."name_data_quality", NEW."name_suffix", NEW."nickname", NEW."personal_id", _pgh_attach_context(), NOW(), \'hmisclientprofile.add\', NEW."id", NEW."phone_number", NEW."physical_description", NEW."place_of_birth", NEW."preferred_communication", NEW."preferred_language", NEW."profile_photo", NEW."pronouns", NEW."pronouns_other", NEW."race", NEW."race_ethnicity", NEW."residence_address", NEW."residence_geolocation", NEW."spoken_languages", NEW."ssn1", NEW."ssn2", NEW."ssn3", NEW."ssn_data_quality", NEW."unique_identifier", NEW."updated_at", NEW."veteran_status"); RETURN NULL;',
                    hash="7df80fa472e45775b31811403979612d8a21277e",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="6274f82cde3d28f2ab48c2e04ee66340abdb741e",
                    operation="UPDATE",

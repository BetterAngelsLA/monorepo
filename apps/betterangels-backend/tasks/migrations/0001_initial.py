    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django_choices_field.fields.IntegerChoicesField(
                        choices=[(0, "To Do"), (1, "In Progress"), (2, "Completed")],
                        choices_enum=tasks.models.Task.Status,
                        db_index=True,
                        default=0,
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["description"], name="task_description_trgm", opclasses=["gin_trgm_ops"]
            ),
        ),
        migrations.AddIndex(
            model_name="task",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["summary"], name="task_summary_trgm", opclasses=["gin_trgm_ops"]
            ),
        ),

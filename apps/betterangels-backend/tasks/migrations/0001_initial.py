    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "tasks_taskevent" ("client_profile_id", "created_at", "created_by_id", "description", "id", "organization_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "status", "summary", "team", "updated_at") VALUES (NEW."client_profile_id", NEW."created_at", NEW."created_by_id", NEW."description", NEW."id", NEW."organization_id", _pgh_attach_context(), NOW(), \'task.add\', NEW."id", NEW."status", NEW."summary", NEW."team", NEW."updated_at"); RETURN NULL;',
                    hash="61cadee1b1fe3bdf9beac0714d3c99e9e9688bf8",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="f7c3e2c1b0daa6e53137908cdb5bfaefa3d15ba3",
                    operation="UPDATE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "tasks_taskevent" ("client_profile_id", "created_at", "created_by_id", "description", "id", "organization_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "status", "summary", "team", "updated_at") VALUES (OLD."client_profile_id", OLD."created_at", OLD."created_by_id", OLD."description", OLD."id", OLD."organization_id", _pgh_attach_context(), NOW(), \'task.remove\', OLD."id", OLD."status", OLD."summary", OLD."team", OLD."updated_at"); RETURN NULL;',
                    hash="051d19db5087d70e433d3fda69e0c84c8eabca11",
                    operation="DELETE",

...
from common.permissions.utils import resolve_organization_id
...
class PermissionedQuerySet(HasRetvalPerm):
    ...
    allow_implicit_org : bool
        When the header is absent, adopt the caller's only organization
        instead of refusing.  For app builds predating #2330; removed by
        #2345.
    """

...
class Query(BaseExpression):
    ...
    def build_filter(self, filter_expr: Q | Expression | dict[str, str] | tuple[str, Any], branch_negated: bool = ..., current_negated: bool = ..., can_reuse: set[str] | None = ..., allow_joins: bool = ..., split_subq: bool = ..., reuse_with_filtered_relation: bool = ..., check_filterable: bool = ...) -> tuple[WhereNode, Iterable[str]]:
        ...
    ...
    def setup_joins(self, names: Sequence[str], opts: Any, alias: str, can_reuse: set[str] | None = ..., allow_many: bool = ..., reuse_with_filtered_relation: bool = ...) -> JoinInfo:
        ...
    ...
    def join(self, join: type[BaseTable | Join], reuse: str | None = ..., reuse_with_filtered_relation: bool = ...) -> str:
        ...

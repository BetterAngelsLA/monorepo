...
class URLPattern:
    ...
    name: str | None
    def __init__(self, pattern: _Pattern, callback: Callable, default_args: dict[str, str] | None = ..., name: str | None = ...) -> None:
        ...
...
class URLResolver:
    ...
    def __init__(self, pattern: _Pattern, urlconf_name: str | None | Sequence[_AnyURL], default_kwargs: dict[str, Any] | None = ..., app_name: str | None = ..., namespace: str | None = ...) -> None:
        ...

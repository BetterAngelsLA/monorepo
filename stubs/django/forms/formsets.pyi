...
class BaseFormSet(Generic[_F], Sized, RenderableFormMixin):
    ...
    def __init__(self, data: _DataT | None = ..., files: _FilesT | None = ..., auto_id: str = ..., prefix: str | None = ..., initial: Sequence[Mapping[str, Any]] | None = ..., error_class: type[ErrorList] = ..., form_kwargs: dict[str, Any] | None = ..., error_messages: Mapping[str, str] | None = ...) -> None:
        ...

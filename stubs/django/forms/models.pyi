...
_Widgets: TypeAlias = ...
_Labels: TypeAlias = ...
_HelpTexts: TypeAlias = ...
_ErrorMessages: TypeAlias = ...
_FormFieldCallback: TypeAlias = ...
...
class BaseModelForm(Generic[_M], BaseForm):
    ...
    def __init__(self, data: _DataT | None = ..., files: _FilesT | None = ..., auto_id: bool | str = ..., prefix: str | None = ..., initial: Mapping[str, Any] | None = ..., error_class: type[ErrorList] = ..., label_suffix: str | None = ..., empty_permitted: bool = ..., instance: _M | None = ..., use_required_attribute: bool | None = ..., renderer: BaseRenderer = ...) -> None:
        ...
...
class ModelChoiceField(ChoiceField):
    ...
    def __init__(self, queryset: None | Manager[models.Model] | QuerySet[models.Model], *, empty_label: _StrOrPromise | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., to_field_name: str | None = ..., limit_choices_to: _AllLimitChoicesTo | None = ..., blank: bool = ..., **kwargs: Any) -> None:
        ...
    ...
    choices: _PropertyDescriptor[_FieldChoices | _ChoicesCallable | CallableChoiceIterator, _FieldChoices | CallableChoiceIterator | ModelChoiceIterator,]
...
class ModelMultipleChoiceField(ModelChoiceField):
    ...
    def to_python(self, value: Any) -> list[Model]:
        ...

...
class ILoop(Interface):
    ...
    def io(fd, events, ref=..., priority=...): # -> None:
        """
    ...
    def timer(after, repeat=..., ref=..., priority=...): # -> None:
        """
    ...
    def signal(signum, ref=..., priority=...): # -> None:
        """
    ...
    def stat(path, interval=..., ref=..., priority=...): # -> None:
        """
